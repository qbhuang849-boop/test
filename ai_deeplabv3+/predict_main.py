...
def main():
    # === 配置参数 ===
    # 输入路径（可以是文件或目录）
    INPUT_PATH = "/home/ej/桌面/翼界项目总览/其他项目/DeepLabV3Plus-Pytorch-master/_tool/20160105_data/data_train/test/images"

    # 输出目录
    OUTPUT_DIR = "/home/ej/桌面/翼界项目总览/其他项目/DeepLabV3Plus-Pytorch-master/_tool/20160105_data/data_train/test/test/1"
